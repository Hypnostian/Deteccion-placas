...
export default function CameraScreen() {
  ...
  const handleCapture = async () => {
    ...
    try {
      ...
      // Redimensiona a máx. 1024px de ancho y comprime a JPEG calidad 0.5
      // para que el base64 resultante no supere el límite de 1024KB del servidor.
      ...
      formBody.append('image_base64', manipulated.base64 ?? '');
